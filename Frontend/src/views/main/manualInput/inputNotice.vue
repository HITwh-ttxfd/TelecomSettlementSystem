  ...
  <div>
    ...
    <el-card>
      ...
      <el-table border style="width: 100%;" max-height="300" :data="tableData">
        ...
        <el-table-column label="通知单收入编码" prop="outType" header-align="center" align="center"/>
        <el-table-column label="营收日期" prop="inMonth" header-align="center" align="center"/>
        <el-table-column label="营收金额" prop="inMoney" header-align="center" align="center"/>
